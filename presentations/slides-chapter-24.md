...
# Chapters 24-25: Advanced RAG
## Search Optimization & Production Systems
...
**Chapter 24 - Search Optimization (Patterns 1-3)**:
1. Hybrid Search (BM25 + Vector)
2. Cross-Encoder Re-Ranking
3. Multi-Query and Query Fusion

**Chapter 25 - Production Systems (Patterns 4-8)**:
...
**Code Examples**:
- `src/chapter-24/` - All implementations
- `src/chapter-24/production_rag.py` - Complete system

**Chapter Content**:
- Chapter 24: Search Optimization (hybrid search, re-ranking, multi-query)
- Chapter 25: Production Systems (agentic RAG, evaluation, caching, routing)
...
- Code examples: `src/chapter-24/` (Chapters 24-25 combined)
